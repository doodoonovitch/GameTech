...
#define LIGHT_AMBIENT_PROPERTY						0	
#define LIGHT_DIFFUSE_PROPERTY						1	
#define LIGHT_SPECULAR_PROPERTY						2

#define POINT_LIGHT_POSITION_PROPERTY				3
#define POINT_LIGHT_ATTENUATION_PROPERTY			4	

#define DIRECTIONAL_LIGHT_DIRECTION_PROPERTY		3
