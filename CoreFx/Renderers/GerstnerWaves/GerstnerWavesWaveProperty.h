...
#ifndef COREFX_RENDERERS_GERSTNERWAVES_WAVEPROPERTY_H
#define COREFX_RENDERERS_GERSTNERWAVES_WAVEPROPERTY_H
...
#endif // COREFX_RENDERERS_GERSTNERWAVES_WAVEPROPERTY_H