...
#ifndef COREFX_RENDERERS_GERSTNERWAVES_HEIGHTMAPCS_H
#define COREFX_RENDERERS_GERSTNERWAVES_HEIGHTMAPCS_H
...
#endif // COREFX_RENDERERS_GERSTNERWAVES_HEIGHTMAPCS_H