...
#ifndef COREFX_RENDERERS_DEEPOCEAN_RENDERER_H
#define COREFX_RENDERERS_DEEPOCEAN_RENDERER_H
...
public:
	...
	{
		Desc(bool precomputeNormals, GLint mapWidth, GLint mapDepth, const std::string & skyboxCubeMapTextureFilename)
...
#endif // COREFX_RENDERERS_DEEPOCEAN_RENDERER_H