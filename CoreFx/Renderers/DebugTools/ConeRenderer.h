...
#ifndef COREFX_RENDERERS_DEBUGTOOLS_CONERERENDERER_H
#define COREFX_RENDERERS_DEBUGTOOLS_CONERERENDERER_H
...
#endif // COREFX_RENDERERS_DEBUGTOOLS_CONERERENDERER_H