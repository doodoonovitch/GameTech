...
PerlinNoiseOceanRenderer::PerlinNoiseOceanRenderer(const Desc & desc)
	...
	, mNoiseHeightTexture(Engine::GetInstance()->GetTextureManager()->LoadTexture2D("Medias/Textures/noise512.tif", GL_REPEAT, GL_REPEAT))
	, mNoiseNormalTexture(Engine::GetInstance()->GetTextureManager()->LoadTexture2D("Medias/Textures/noise512_NRM.tif", GL_REPEAT, GL_REPEAT))
